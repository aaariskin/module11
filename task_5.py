...
vol_new_planet = 4 / 3 * math.pi * math.pow(radius, 3)
vol_earf = 10.8321 * math.pow(10, 11)

if vol_earf > vol_new_planet:
    print(
        f'Объём планеты Земля больше в {round(vol_earf/vol_new_planet,3)} раз')
else:
    print(
        f'Объём планеты Земля меньше в (1/{round(vol_earf/vol_new_planet,3)}) = {round(vol_new_planet/vol_earf,3)} раз'
    )
